...
export default function WorkOrderList() {
  ...
  const statusColor = (status) => {
    switch (status) {
      ...
      case 'In Progress': return 'bg-blue-100 text-blue-800 dark:bg-blue-200 dark:text-blue-900';
  ...
  return (
    <Routes>
      <Route
        path="/"
        element={
          <div className="mt-4 md:mt-6 p-4 md:p-8 bg-gray-200 dark:bg-gray-800 rounded-2xl">
            <div className="flex flex-row justify-between items-center mb-8 gap-4">
              <h1 className="text-xl md:text-4xl font-extrabold text-gray-900 dark:text-white leading-tight">Work Orders Dashboard</h1>
              <button
              ...
              {orders.length === 0 ? (
                ...
                orders.map((order) => (
                  <div
                    ...
                    className="group cursor-pointer p-6 bg-white dark:bg-gray-900 shadow-md rounded-xl hover:shadow-xl hover:ring-2 hover:ring-blue-500 transform hover:-translate-y-1 transition duration-200 ease-in-out border border-gray-200 dark:border-gray-700"
                  >
