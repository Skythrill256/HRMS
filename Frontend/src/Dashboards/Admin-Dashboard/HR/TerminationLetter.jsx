...
🔹Termination Details
Date of Issue of Termination Letter: 
Notice Period Served: (Yes/No/Partial)
Final Settlement Instructions: (if any)
Return of Company Property Instructions: (Laptop, ID, etc.)
Any Outstanding Amount / Dues Details
...
Download as PDF / Email directly to employee
Digital Signature inclusion
Status Tracking (Issued, Delivered, Acknowledged)`
            );
        }
    ...
    const handleGeneratePDF = () => {
        ...
        const opt = {
            margin: 0,
            filename: `${employeeName || 'Termination_Letter'}.pdf`,
