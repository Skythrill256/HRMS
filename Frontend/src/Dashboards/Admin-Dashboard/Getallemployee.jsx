                                ...
                                .map((employee) => (
                                    <div key={employee.id} className="relative bg-card dark:bg-gray-700 rounded-2xl shadow-md">
                                        ...
                                        <div className='flex justify-center items-center gap-4 py-3 border-t border-gray-200 dark:border-gray-600'>
                                            ...
                                            {employee.loginRestricted ? (
                                                <FaCheckCircle className="text-green-600 hover:text-green-800 cursor-pointer text-xl" onClick={(e) => { e.stopPropagation(); handleRestrictLogin(employee.id); }} />
                                            ) : (
                                                <FaBan className="text-red-600 hover:text-red-800 cursor-pointer text-xl" onClick={(e) => { e.stopPropagation(); handleRestrictLogin(employee.id); }} />
                                            )}
                                        </div>
                                    </div>
                                ))}
