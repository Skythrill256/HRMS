...
const ClientProfile = ({ clientData }) => {
    ...
    // clientData is now passed directly from AllClient.jsx based on URL param
    if (!clientData) {
        // This case should ideally be caught by AllClient before rendering ClientProfile,
        // but it's good for a fallback.
        return (
            <div className="p-4 text-red-500 text-center">
                Client data not found.
                <button onClick={() => navigate('/admin-dashboard/Allclients')} className="mt-2 text-blue-600 underline">
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-2 sm:p-4 rounded-3xl w-full ">
            <div className=" mx-auto bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden mt-8">
                ...
                <div className="relative p-6 sm:p-8 bg-gradient-to-br from-blue-400 to-indigo-800 dark:from-blue-700 dark:to-indigo-900 text-white flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center rounded-t-3xl">
                    <button
                        onClick={() => navigate('..')} // Navigate back to the parent route (e.g., /admin-dashboard/Allclients)
                ...
                <div className="p-4 sm:p-8 border-b border-gray-100 dark:border-gray-800">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        ...
                        <div className="flex flex-wrap justify-end gap-2 sm:flex-nowrap">
                            {/* Assuming addproject route is separate or handled differently */}
                            <Link to={`/admin-dashboard/projects/addproject/${id}`}>
                                <button className="bg-blue-500 text-white text-sm px-4 py-2 rounded hover:bg-blue-600">Add Project</button>
                            </Link>
                            ...
                            {/* New: Edit Client button using relative path */}
                            <button
                                // Navigates to /admin-dashboard/Allclients/:id/edit
